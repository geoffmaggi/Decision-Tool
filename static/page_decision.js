function main(body) {
  ...
  var end = window.location.pathname.lastIndexOf('.');
  
  var decisionID = end == -1 ? window.location.pathname.substr(start) : window.location.pathname.substr(start, end-start);
